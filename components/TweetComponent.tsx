  ...
  return (
    <div className='flex flex-col space-x-3 border-y p-5 border-gray-100'>
      <div className='flex space-x-3'>
        <img className='h-10 w-10 rounded-full object-cover' src={tweet.profileImg} alt='profile-img' />
        <div>
          ...
          {tweet.image && (
            <img className='m-5 ml-0 mb-1 max-h-80 rounded-lg object-cover shadow-sm' src={tweet.image} alt='tweet-img'/>
          )}
        </div>
      </div>
        ...
        <div className='my-2 mt-5 max-h-44 space-y-5 overflow-y-scroll border-t border-gray-100 p-5'>
          {comments.map(comment => (
            <div key={comment._id} className='relative flex space-x-2'>
              ...
              <img src={comment.profileImg} alt='comment-profile-img' className='mt-2 h-7 w-7 object-cover rounded-full'/>
              <div>
                <div className='flex items-center space-x-1'>
